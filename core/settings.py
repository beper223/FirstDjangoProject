...
LOGGING = {
    ...
    'handlers': {
        # вывод в консоль (для работы сервера)
        'console': {
            'level': 'INFO',
            'class': 'logging.StreamHandler',
            'formatter': 'simple',
        },
        # файл с логами HTTP-запросов
        'http_file': {
            'level': 'INFO',
    ...
    'loggers': {
        # Логи самого Django (работа сервера)
        'django': {
            'handlers': ['console'],
            'level': 'INFO',
            'propagate': True,
        },
        # Логи HTTP-запросов (middleware Django)
        'django.server': {
            'handlers': ['http_file'],
            'level': 'INFO',
            'propagate': False,
